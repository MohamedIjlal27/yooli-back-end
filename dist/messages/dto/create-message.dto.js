...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: message_schema_1.MessageType, default: message_schema_1.MessageType.TEXT }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(message_schema_1.MessageType),
    __metadata("design:type", String)
], CreateMessageDto.prototype, "type", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'https://example.com/media.jpg', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateMessageDto.prototype, "mediaUrl", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'document.pdf', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
